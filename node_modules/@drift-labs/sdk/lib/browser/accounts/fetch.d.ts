...
export declare function fetchRevenueShareAccount(connection: Connection, program: Program, authority: PublicKey): Promise<RevenueShareAccount | null>;
export declare function fetchRevenueShareEscrowAccount(connection: Connection, program: Program, authority: PublicKey): Promise<RevenueShareEscrowAccount | null>;
