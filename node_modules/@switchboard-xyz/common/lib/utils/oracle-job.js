 ...
 */
export function normalizeOracleJob(data) {
    const parseJobObject = (jobData) => {
        ...
        else if (!NonEmptyArrayUtils.safeValidate(jobData.tasks)) {
 ...
 */
export function serializeOracleJob(data) {
 ...
 */
export function deserializeOracleJob(data) {
