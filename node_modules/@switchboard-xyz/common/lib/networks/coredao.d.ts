...
export declare const SWITCHBOARD_COREDAO_MAINNET_CONFIG: IEvmNetworkConfig;
export declare const SWITCHBOARD_COREDAO_TESTNET_CONFIG: IEvmNetworkConfig;
/**
...
```
 */
export declare const SWITCHBOARD_COREDAO_CONFIG: IChainConfig;
