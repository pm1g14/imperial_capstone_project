...
export class State {
    ...
    static keyFromSeed(program) {
        const [state] = web3.PublicKey.findProgramAddressSync([Buffer.from('STATE')], program.programId);
        return state;
    }
    /**
    ...
    setConfigsIx(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ix = yield this.program.instruction.stateSetConfigs({
                ...
                addCostWl: (_g = params.addCostWl) !== null && _g !== void 0 ? _g : web3.PublicKey.default,
                rmCostWl: (_h = params.rmCostWl) !== null && _h !== void 0 ? _h : web3.PublicKey.default,
            }, {
                accounts: {
                    state: this.pubkey,
