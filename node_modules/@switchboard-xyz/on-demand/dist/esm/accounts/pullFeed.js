...
export class PullFeed {
    ...
    static fetchUpdateIxSvm(params, debug, payer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const slotHashes = (_a = params.recentSlothashes) !== null && _a !== void 0 ? _a : (yield RecentSlotHashes.fetchLatestNSlothashes(connection, 30));
            const crossbarClient = (_b = params.crossbarClient) !== null && _b !== void 0 ? _b : CrossbarClient.default();
    ...
    static fetchUpdateManyIx(program_1, params_1) {
        return __awaiter(this, arguments, void 0, function* (program, params, debug = false) {
            ...
            const slotHashes = (_d = params.recentSlothashes) !== null && _d !== void 0 ? _d : (yield RecentSlotHashes.fetchLatestNSlothashes(connection, 30));
