...
class LutMap {
    ...
    static keyFromSeed(program, queue, authority) {
        return __awaiter(this, void 0, void 0, function* () {
            const [lut] = anchor_30_1.web3.PublicKey.findProgramAddressSync([
    ...
    loadLut() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lutData = anchor_30_1.web3.AddressLookupTableAccount.deserialize(lutAccountInfo.data);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const oracle of oracles) {
                for (const feed of feeds) {
                    const [statsKey] = anchor_30_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from('OracleFeedStats'), feed.toBuffer(), oracle.toBuffer()], this.program.programId);
