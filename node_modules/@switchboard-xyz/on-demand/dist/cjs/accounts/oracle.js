...
class Oracle {
    ...
    static create(program, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const oracle = anchor_30_1.web3.Keypair.generate();
            const oracleStats = anchor_30_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from('OracleStats'), oracle.publicKey.toBuffer()], program.programId)[0];
    ...
    static createSVM(program, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [oracle] = anchor_30_1.web3.PublicKey.findProgramAddressSync([
                buffer_1.Buffer.from('Oracle'),
                params.queue.toBuffer(),
                params.sourceOracleKey.toBuffer(),
            ], program.programId);
            const oracleStats = anchor_30_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from('OracleStats'), oracle.toBuffer()], program.programId)[0];
    ...
    findSolanaOracleFromPDA() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const oracle of solanaOracles) {
                const [oraclePDA] = anchor_30_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from('Oracle'), oracleData.queue.toBuffer(), oracle.toBuffer()], this.program.programId);
    ...
    verificationStatus() {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield this.loadData();
            const now = new anchor_30_1.BN(Date.now() / 1000);
     ...
     */
    statsKey() {
        return anchor_30_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from('OracleStats'), this.pubkey.toBuffer()], this.program.programId)[0];
    }
    loadLookupTableKey() {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield this.loadData();
