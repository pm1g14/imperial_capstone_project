...
class State {
    ...
    static keyFromSeed(program) {
        const [state] = anchor_30_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from('STATE')], program.programId);
        return state;
    }
    /**
    ...
    setConfigsIx(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ix = yield this.program.instruction.stateSetConfigs({
                ...
                addCostWl: (_g = params.addCostWl) !== null && _g !== void 0 ? _g : anchor_30_1.web3.PublicKey.default,
                rmCostWl: (_h = params.rmCostWl) !== null && _h !== void 0 ? _h : anchor_30_1.web3.PublicKey.default,
            }, {
                accounts: {
                    state: this.pubkey,
