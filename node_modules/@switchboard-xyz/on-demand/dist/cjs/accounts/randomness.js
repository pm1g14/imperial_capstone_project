...
class Randomness {
    ...
    commitIx(queue, authority_) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isNonSolana(queue)) {
                ...
                [oracle] = anchor_30_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from('Oracle'), queue.toBuffer(), solanaOracle.toBuffer()], spl.ON_DEMAND_MAINNET_PID);
            }
            else {
    ...
    revealIx(payer_) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const stats = anchor_30_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from('OracleRandomnessStats'), data.oracle.toBuffer()], this.program.programId)[0];
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (;;) {
                ...
                const tx = yield InstructionUtils_js_1.InstructionUtils.asV0TxWithComputeIxs({
                    connection,
                    ixs: [
                        anchor_30_1.web3.ComputeBudgetProgram.setComputeUnitPrice({
            ...
            for (;;) {
                ...
                const tx = yield InstructionUtils_js_1.InstructionUtils.asV0TxWithComputeIxs({
                    ...
                    ixs: [
                        ...
                        anchor_30_1.web3.ComputeBudgetProgram.setComputeUnitLimit({
    ...
    static createAndCommitIxs(program, queue, payer_) {
        return __awaiter(this, void 0, void 0, function* () {
            const payer = Randomness.getPayer(program, payer_);
            const accountKeypair = anchor_30_1.web3.Keypair.generate();
