...
class InstructionUtils {
    ...
    static asV0TxWithComputeIxs(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const priorityFeeIx = anchor_30_1.web3.ComputeBudgetProgram.setComputeUnitPrice({
                microLamports: (_b = params.computeUnitPrice) !== null && _b !== void 0 ? _b : 0,
            });
            const simulationComputeLimitIx = anchor_30_1.web3.ComputeBudgetProgram.setComputeUnitLimit({
                units: 1400000, // 1.4M compute units
            });
            const recentBlockhash = (yield params.connection.getLatestBlockhash())
                .blockhash;
            const simulateMessageV0 = new anchor_30_1.web3.TransactionMessage({
                recentBlockhash,
            ...
            const simulateTx = new anchor_30_1.web3.VersionedTransaction(simulateMessageV0);
            try {
