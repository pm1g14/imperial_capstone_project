...
class Secp256k1InstructionUtils {
    ...
    static buildSecp256k1Instruction(signatures, instructionIndex) {
        ...
        // common message
        common_1.NonEmptyArrayUtils.validate(signatures);
      ...
      `);
        ...
        return new anchor_30_1.web3.TransactionInstruction({
            programId: anchor_30_1.web3.Secp256k1Program.programId,
