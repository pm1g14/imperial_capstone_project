...
const readonlyWallet = {
    publicKey: anchor_30_1.web3.PublicKey.default,
    signTransaction: () => {
...
class AnchorUtils {
    static initWalletFromKeypair(keypair) {
        return __awaiter(this, void 0, void 0, function* () {
            const { default: NodeWallet } = yield Promise.resolve().then(() => __importStar(require('@coral-xyz/anchor-30/dist/cjs/nodewallet')));
    ...
    static initKeypairFromFile(filePath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const keypair = anchor_30_1.web3.Keypair.fromSecretKey(secretKey);
            return keypair;
        });
    }
    /**
    ...
    static loadProgramFromConnection(connection, wallet, programId) {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = new anchor_30_1.AnchorProvider(connection, wallet !== null && wallet !== void 0 ? wallet : readonlyWallet);
    ...
    static loadProgramFromProvider(provider, programId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield anchor_30_1.Program.at(pid, provider);
        });
    }
    /**
    ...
    static loadProgramFromEnv() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return anchor_30_1.Program.at(pid, config.provider);
        });
    }
    /**
    ...
    static loadEnv() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const connection = new anchor_30_1.web3.Connection(data.json_rpc_url, {
                commitment,
            ...
            const provider = new anchor_30_1.AnchorProvider(connection, wallet);
            ...
            const program = yield anchor_30_1.Program.at(pid, provider);
            return {
    ...
    static loggedEvents(program, logs) {
        const coder = new anchor_30_1.BorshEventCoder(program.idl);
        const out = [];
        logs.forEach(log => {
