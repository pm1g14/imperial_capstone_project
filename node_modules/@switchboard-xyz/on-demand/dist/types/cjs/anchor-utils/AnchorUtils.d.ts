import { AnchorProvider, Program, Provider, Wallet, web3 } from '@coral-xyz/anchor-30';
type SolanaConfig = {
    rpcUrl: string;
    webSocketUrl: string;
    keypairPath: string;
...
export declare class AnchorUtils {
     ...
     */
    static initWalletFromFile(filePath: string): Promise<readonly [import("@coral-xyz/anchor-30/dist/cjs/nodewallet").default, web3.Keypair]>;
    /**
     ...
     */
    static loadProgramFromConnection(connection: web3.Connection, wallet?: Wallet, programId?: web3.PublicKey): Promise<Program<import("@coral-xyz/anchor-30").Idl>>;
    /**
     ...
     * @returns {Promise<Program>} A promise that resolves to the loaded Anchor program.
     */
    static loadProgramFromProvider(provider: Provider, programId?: web3.PublicKey): Promise<Program<import("@coral-xyz/anchor-30").Idl>>;
    /**
