...
declare function checkedAddress<TAddress extends string = string>(input: Address<TAddress> | TransactionSigner<TAddress>): Address<TAddress>;
declare function checkedTransactionSigner<TAddress extends string = string>(input: Address<TAddress> | TransactionSigner<TAddress>): TransactionSigner<TAddress>;
/**
 ...
 */
declare function getOldestSignatureForAddress<TCluster>(rpc: GetOldestSignatureForAddressRpc<TCluster>, address: Address, config?: GetOldestSignatureForAddressConfig): Promise<ReturnType<GetSignaturesForAddressApi["getSignaturesForAddress"]>[0]>;
 ...
 */
declare function insertReferenceKeyToTransactionMessage<TTransaction extends BaseTransactionMessage>(reference: Address, transaction: TTransaction): TTransaction;
/**
 ...
 * Note: The `transaction` must have at least one non-memo instruction.
 */
declare function insertReferenceKeysToTransactionMessage<TTransaction extends BaseTransactionMessage>(references: Address[], transaction: TTransaction): TTransaction;

/**
 * Codama dependency map to utilize gill imports
 */
declare const GILL_EXTERNAL_MODULE_MAP: Record<string, string>;
/**
 ...
 * ```
 */
declare function createCodamaConfig({ idl, clientJs, clientRust, dependencyMap, }: {
    idl: string;
    clientJs: string;
    clientRust?: string;
