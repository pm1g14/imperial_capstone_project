...
async function getOldestSignatureForAddress(rpc, address, config) {
  ...
  if (!signatures.length) {
    throw new kit.SolanaError(kit.SOLANA_ERROR__TRANSACTION_ERROR__UNKNOWN, {
  ...
  try {
    ...
    if (kit.isSolanaError(err, kit.SOLANA_ERROR__TRANSACTION_ERROR__UNKNOWN)) return oldest;
    throw err;
  }
}
...
exports.GILL_EXTERNAL_MODULE_MAP = GILL_EXTERNAL_MODULE_MAP;
exports.LAMPORTS_PER_SOL = LAMPORTS_PER_SOL;
exports.assertKeyPairIsExtractable = assertKeyPairIsExtractable;
exports.checkedAddress = checkedAddress;
exports.checkedTransactionSigner = checkedTransactionSigner;
exports.createCodamaConfig = createCodamaConfig;
...
exports.getOldestSignatureForAddress = getOldestSignatureForAddress;
exports.getPublicSolanaRpcUrl = getPublicSolanaRpcUrl;
exports.insertReferenceKeyToTransactionMessage = insertReferenceKeyToTransactionMessage;
exports.insertReferenceKeysToTransactionMessage = insertReferenceKeysToTransactionMessage;
