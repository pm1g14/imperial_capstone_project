 ...
 */
export declare function tokenUiAmountToAmount(uiAmount: number, decimals: number): bigint;
/**
 ...
 */
export declare function tokenAmountToUiAmount(amount: bigint, decimals: number): number;
//# sourceMappingURL=ui-amount.d.ts.map