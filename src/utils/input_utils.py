...
class InputUtils:
    ...
    @staticmethod
    def convert_initial_data_to_dataframe(function_number: int, columns: List[str], input_path: str | None = None, output_path: str | None = None, submission_path: str | None = None) -> pd.DataFrame:
