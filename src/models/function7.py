...
class HyperparameterTuningModel(HomoskedasticMultiDimensionalBlackBoxModel):
    ...
    def _get_tensors_from_dataframe(self) -> Tuple[torch.Tensor, torch.Tensor]:
        X_np = np.ascontiguousarray(self._dataset[['x1', 'x2', 'x3', 'x4', 'x5', 'x6']].to_numpy(), dtype=np.double)
